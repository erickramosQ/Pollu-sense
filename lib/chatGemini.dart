...
class GenerativeAISample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:
          const ChatScreen(title: 'Chat with Gemini - Question about lichens '),
    );
  }
}
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: text(widget.title, 16.0, FontWeight.bold,
            const Color.fromARGB(255, 0, 0, 0), FontStyle.normal),
      ),
      body: switch (apiKey) {
...
class ApiKeyWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return ChatWidget(apiKey: dotenv.env['API_KEY'] ?? '');
  }
}
              ...
              children: [
                ...
                if (!_loading)
                  ...
                  const CircularProgressIndicator(
                    color: Color.fromARGB(255, 64, 148, 238),
                  ),
              ],
            ),
          ),
